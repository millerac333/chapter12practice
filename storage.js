...
const recordPlayer = {
    ...
    description: "I enjoy listening to my father's old vinyal collection on this record player while I cook food."
}
...
const woodKitchenTable = {
    ...
    location: "Kitchen",
    description: "This is a barstool styke kitchen table that I found on craigslist."
}
...
const couch = {
    name: "Couch",
    location: "Family room",
    description: "I sit on this green piece of furniture to relax or watch television."
}
...
const bed = {
    ...
    description: "I share this queen-size bed with my fiance and dog. I wish it was a king-size bed."
}
...
const nightstand = {
    name: "Nightstand",
    location: "Master Bedroom",
    description: "This is a hand-painted, white nightstand that I refinished after finding it at a flea market in 2015."
}
...
const crib = {
    name: "Crib",
    location: "Nursery",
    description: "This is a new, white crib purchashed from Pottery Barn Baby (e_e)"
}
...
const coloredPencilSet = {
    ...
    location: "Kitchen wood shelf",
    description: "This is a 64-piece colored penicil set used frequently by my fiance and I to color with our child."
}
